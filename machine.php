    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="machine.php"><i class="fa fa-circle-o active"></i> Machines</a></li>
            <li><a href="manage_users.php"><i class="fa fa-circle-o active"></i> Machines</a></li>
          </ul>
        </li>
	...
	while ($row = mysqli_fetch_assoc($result)){
				...
				?>
                  <tr>
                    ...
                    <td><a class="btn btn-danger glyphicon glyphicon-remove" href="javascript:if(confirm('Anda yakin Mau menghapus?'))
{document.location='delete_machine.php?machine_cd=<?php echo $row['machine_cd']; ?>';}"></a>
                    </td>
                    <td><a class="btn btn-danger glyphicon glyphicon-edit" href="javascript:if(confirm('Anda yakin Mau Mengedit?'))
{document.location='edit_machine.php?machine_cd=<?php echo $row['machine_cd']; ?>';}"></a>
                    </td>
                  </tr>
                  <?php 
                    }
            ...
            <div class="box-footer clearfix">
              ...
              <a href="machine_report.php" class="btn btn-sm btn-default btn-flat pull-right glyphicon glyphicon-print"></a>
            </div>
            <!-- /.box-footer -->
          </div>    
    </section>
