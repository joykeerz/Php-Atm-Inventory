...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <?php
    $code = $_GET['machine_cd'];
    $sql = mysqli_query ($db,"SELECT * FROM machine WHERE machine_cd = '$code'");
...
if(isset($_POST['edit'])) {
    ...
    $sqla = mysqli_query($db, "UPDATE machine SET machine_name ='$name', machine_type  = '$type', machine_model  = '$model', machine_quantity  = '$qty', machine_location  = '$location', date_in  = '$datein', date_out  = '$dateout', machine_status  = '$status' WHERE machine_cd = '$code'");
        ...
        if ($sqla){
                ...
                <?php
                $sqlz = "SELECT * FROM machine WHERE machine_cd = '$code'";
	...
	while ($rowz = mysqli_fetch_assoc($resultz)){
				...
				?>
                  <tr>
                    <td><a href="pages/examples/invoice.html"><?=$rowz['machine_cd'];?></a></td>
                    <td><?=$rowz['machine_name'];?></td>
                    <td><span class="label label-success"><?=$rowz['machine_quantity'];?></span></td>
                    <td>
                      <div class="sparkbar" data-color="#00a65a" data-height="20"><?=$rowz['machine_location'];?></div>
                    </td>
                  </tr>
                  <?php 
                    }
            ...
            <form role="form" method="POST">
              <div class="box-body">
                <div class="form-group  col-xs-2">
                  ...
                  <input readonly="" name="codes" type="text" class="form-control disabled" id="exampleInputEmail1" placeholder="<?=$result2['machine_cd'];?>" value="<?=$result2['machine_cd'];?>" >
                  
                </div>
                  
                  <div class="form-group  col-xs-2">
                  <label for="exampleInputEmail1">Machine Name</label>
                  <input name="name"  type="text"  class="form-control" id="exampleInputEmail1" placeholder="" value="<?=$result2['machine_name'];?>">
                </div>
                  
                  <div class="form-group  col-xs-2">
                  <label for="exampleInputEmail1">Machine Type</label>
                  <select name="type" class="form-control select2" style="width: 100%;">
                      <option ><?=$result2['machine_type'];?></option>
                    <option>TALL</option>
                    <option>SHORT</option>
                  ...
                  <select name="model"  class="form-control select2" style="width: 100%;">
                      <option  ><?=$result2['machine_model'];?></option>
                    <option>H22NL</option>
                    <option>H22VL</option>
                    <option>H68NL</option>
                    <option>H68VL</option>
                ...
                <div class="form-group">
                  ...
                  <input name="qty"  type="text"  class="form-control" id="exampleInputEmail1" placeholder="" value="<?=$result2['machine_quantity'];?>">
                </div>
                  
                  <div class="form-group">
                  <label for="exampleInputEmail1">Machine Location</label>
                  <input name="location"  type="text"  class="form-control" id="exampleInputEmail1" placeholder="" value="<?=$result2['machine_location'];?>">
                </div>
                  
                  <div class="form-group">
                  <label for="exampleInputEmail1">Date In</label>
                  <input name="datein"  type="date"  class="form-control" id="exampleInputEmail1" placeholder="" value="<?=$result2['date_in'];?>">
                </div>  
                  
                  <div class="form-group">
                  <label for="exampleInputEmail1">Date Out</label>
                  <input name="dateout" type="date"  class="form-control" id="exampleInputEmail1" placeholder="" value="<?=$result2['date_out'];?>">
                </div>
                  
                  <div class="form-group">
                  <label for="exampleInputEmail1">Machine Status</label>
                  <select name="status"  class="form-control select2" style="width: 100%">
                      <option><?=$result2['machine_status'];?></option>
                    <option>GOOD</option>
